...
class DQN:
    def __init__(self,):
        ...
        self.L = 1  # Number of training episodes L = 20
...
def train(machine, e_ave, job_insert):
    ...
    Total_tard,Total_uk_ave,Total_makespan = d.main(J_num, M_num, O_num, J, Processing_time, D, A, Change_cutter_time, Repair_time, EL)
